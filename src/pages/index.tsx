  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Management Application - Elevating human resources to the next level. Streamline your HR tasks, optimize your workflows, and foster a better workplace environment."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Management Application - Elevating human resources to the next level. Streamline your HR tasks, optimize your workflows, and foster a better workplace environment.`}
            </Text>
            <Box
