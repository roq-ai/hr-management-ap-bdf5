...
type ColumnType = ColumnDef<BenefitsInterface, unknown>;

interface BenefitsListPageProps {
...
export function BenefitsListPage(props: BenefitsListPageProps) {
  const {
    filters = {},
    titleProps = {},
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<BenefitsInterface>>(
  ...
  const handleView = (row: BenefitsInterface) => {
